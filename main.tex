...
\item{Scenario B: End-to-End Latency.} We measured the time elapsed between sending the correct PIN code from the Web App and the visual confirmation on the LED strip.
...
Six functional tests were conducted:
...
\begin{center}
    \url{https://github.com/jsorv/IoT-group-12}
\end{center}
